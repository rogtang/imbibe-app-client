...
class CocktailItem extends Component {
  ...
  render() {
    /*const { strDrink, strIBA, strGlass, strInstruction, strDrinkThumb, strIngredient1, 
        strIngredient2, strIngredient3, strIngredient4, strMeasure1, strMeasure2, strMeasure3, strMeasure4, notes } = this.props
*/
    return (
        ...
        <section className="cocktail-item-body">
          <div>
            <img src="https://www.thecocktaildb.com/images/media/drink/5noda61589575158.jpg" alt="Margarita" width="200px" height="200px"/>
     ...
     <p>Instructions: "Rub the rim of the glass with the lime slice to make the salt stick to it. Take care to moisten only the outer rim and sprinkle the salt on it. The salt should present to the lips of the imbiber and never mix into the cocktail. Shake the other ingredients with ice, then carefully pour into the glass."</p> 
    <p> User Notes: Tastes better garnished with lemon or lime. </p>
            <Link to={`/edit/1`}>
            <button type="button" id={1}>Edit</button></Link>
            
            <button id={1} type="button" onClick={this.handleDelete}>Delete</button>
